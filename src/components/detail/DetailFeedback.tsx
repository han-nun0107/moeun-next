...
const DetailFeedback = () => {
  return (
    <div className="mb-[100px]">
      <h3 className="text-bold-lg border-b pb-5">상품 후기</h3>
      <div className="mt-[35px] flex gap-[31px] border-b border-gray-300 pb-[30px]">
        <img
          src={detailMock.images[0].image_url}
          alt="임시 이미지"
        ...
        <div className="flex">
          ...
          <div className="ml-[180px] flex gap-3">
            ...
            <span className="text-gray-700">2025.08.15</span>
          </div>
        </div>
      </div>
    </div>
